...
namespace 科技计划项目档案数据采集管理系统
{
    public partial class Frm_MyWork : Form
    {
        ...
        /// 禁用背景色
        /// </summary>
        private System.Drawing.Color DisEnbleColor = System.Drawing.Color.Gray;
        /// <summary>
        /// 开始加工指定的对象
        /// </summary>
        ...
        private void Btn_OpenFile_Click(object sender, EventArgs e)
        {
            ...
            if(openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                if("btn_JH_OpenFile".Equals(button.Name))
                {
                    ...
                    dgv_JH_FileList.Rows[index].Cells["link"].Value = path;
                }
                else if("btn_JH_XM_OpenFile".Equals(button.Name))
                {
                    int index = dgv_JH_XM_FileList.Rows.Add();
                    dgv_JH_XM_FileList.Rows[index].Cells["jh_xm_link"].Value = path;
                }
                else if("btn_JH_XM_KT_OpenFile".Equals(button.Name))
                {
                    int index = dgv_JH_XM_KT_FileList.Rows.Add();
                    dgv_JH_XM_KT_FileList.Rows[index].Cells["jh_xm_kt_link"].Value = path;
                }
                else if("btn_JH_XM_KT_ZKT_OpenFile".Equals(button.Name))
                {
                    int index = dgv_JH_XM_KT_ZKT_FileList.Rows.Add();
                    dgv_JH_XM_KT_ZKT_FileList.Rows[index].Cells["jh_xm_kt_zkt_link"].Value = path;
                }
                else if("btn_JH_KT_OpenFile".Equals(button.Name))
                {
                    int index = dgv_JH_KT_FileList.Rows.Add();
                    dgv_JH_KT_FileList.Rows[index].Cells["jh_kt_link"].Value = path;
                }
                else if("btn_JH_KT_ZKT_OpenFile".Equals(button.Name))
                {
                    int index = dgv_JH_KT_ZKT_FileList.Rows.Add();
                    dgv_JH_KT_ZKT_FileList.Rows[index].Cells["jh_kt_zkt_link"].Value = path;
                }
                else if("btn_Imp_OpenFile".Equals(button.Name))
                {
                    int index = dgv_Imp_FileList.Rows.Add();
                    dgv_Imp_FileList.Rows[index].Cells["imp_link"].Value = path;
                }
                else if("btn_Imp_Dev_OpenFile".Equals(button.Name))
                {
                    int index = dgv_Imp_Dev_FileList.Rows.Add();
                    dgv_Imp_Dev_FileList.Rows[index].Cells["imp_dev_link"].Value = path;
                }
        ...
        private void LoadTreeList(object planId, ControlType type)
        {
            ...
            if(workType == WorkType.Default)
            {
                ...
                //根据重大专项查询具体专项信息
                DataTable table = SqlHelper.ExecuteQuery($"SELECT imp_id,imp_code FROM imp_dev_info WHERE imp_obj_id='{treeNode.Name}' AND imp_source_id='{UserHelper.GetInstance().User.UserKey}'");
                foreach(DataRow row in table.Rows)
                {
                    TreeNode treeNode2 = new TreeNode()
                    {
                        Name = row["imp_id"].ToString(),
                        Text = row["imp_code"].ToString(),
                        Tag = ControlType.Imp_Sub
                    };
                    treeNode.Nodes.Add(treeNode2);
                    //根据【专项信息】查询【项目/课题】集
                    List<object[]> list = SqlHelper.ExecuteColumnsQuery($"SELECT pi_id,pi_code,pi_categor FROM project_info WHERE pi_obj_id='{treeNode2.Name}' AND pi_source_id='{UserHelper.GetInstance().User.UserKey}'", 3);
                    for(int i = 0; i < list.Count; i++)
                    {
                        ...
                        List<object[]> list2 = SqlHelper.ExecuteColumnsQuery($"SELECT si_id,si_code,si_categor FROM subject_info WHERE pi_id='{treeNode3.Name}' AND si_source_id='{UserHelper.GetInstance().User.UserKey}'", 3);
                        for(int j = 0; j < list2.Count; j++)
                        {
                            ...
                            List<object[]> list3 = SqlHelper.ExecuteColumnsQuery($"SELECT si_id,si_code,si_categor FROM subject_info WHERE pi_id='{treeNode4.Name}' AND si_source_id='{UserHelper.GetInstance().User.UserKey}'", 3);
            ...
            else if(workType == WorkType.PaperWork)
            {
                ...
                for(int i = 0; i < list.Count; i++)
                {
                    ...
                    for(int j = 0; j < list2.Count; j++)
                    {
                        ...
                        List<object[]> list3 = SqlHelper.ExecuteColumnsQuery($"SELECT si_id,si_code,si_categor FROM subject_info WHERE pi_id='{treeNode3.Name}' AND si_source_id='{UserHelper.GetInstance().User.UserKey}'", 3);
                        for(int k = 0; k < list3.Count; k++)
                        {
                            TreeNode treeNode4 = new TreeNode()
                            {
        ...
        private void TreeView_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            else if(type == ControlType.Plan_Project_Topic)
            {
                ...
                {
                    ShowTab("imp", 0);
                    LoadImpInfo(e.Node.Parent.Parent.Parent.Name);
            ...
            else if(type == ControlType.Imp || type == ControlType.Imp_Dev)
            {
                ...
                ShowTab("imp", 0);
                LoadImpInfo(e.Node.Name);

            }
            else if(type == ControlType.Imp_Sub || type == ControlType.Imp_Dev_Sub)
            {
                tab_MenuList.TabPages.Clear();

                ShowTab("imp", 0);
                LoadImpInfo(e.Node.Parent.Name);
        ...
        private void LoadImpInfo(object objId)
        {
            ...
            if(_obj != null)
            {
                ...
                {
                    DataTable table = SqlHelper.ExecuteQuery($"SELECT * FROM data_dictionary WHERE dd_pId = '{objId}' ORDER BY dd_sort");
        ...
        private void Tab_FileInfo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                object objid = dgv_JH_FileList.Tag;
                btn_JH_AddFile.Visible = btn_JH_OpenFile.Visible = false;
                if(index == 0)
                    btn_JH_AddFile.Visible = btn_JH_OpenFile.Visible = true;
            ...
            {
                object objid = dgv_JH_XM_FileList.Tag;
                btn_JH_XM_AddFile.Visible = btn_JH_XM_OpenFile.Visible = false;
                if(index == 0)
                    btn_JH_XM_AddFile.Visible = btn_JH_XM_OpenFile.Visible = true;
                else if(index == 1)//文件核查
                {
                    if(objid != null)
                    {
            ...
            {
                object objid = dgv_JH_KT_FileList.Tag;
                btn_JH_KT_AddFile.Visible = btn_JH_KT_OpenFile.Visible = false;
                if(index == 0)
                    btn_JH_KT_AddFile.Visible = btn_JH_KT_OpenFile.Visible = true;
                else if(index == 1)//文件核查
                {
                    if(objid != null)
                    {
            ...
            {
                object objid = dgv_JH_XM_KT_FileList.Tag;
                btn_JH_XM_KT_AddFile.Visible = btn_JH_XM_KT_OpenFile.Visible = false;
                if(index == 0)
                    btn_JH_XM_KT_AddFile.Visible = btn_JH_XM_KT_OpenFile.Visible = true;
                else if(index == 1)//文件核查
                {
                    if(objid != null)
                    {
            ...
            {
                object objid = dgv_JH_XM_KT_ZKT_FileList.Tag;
                btn_JH_XM_KT_ZKT_AddFile.Visible = btn_JH_XM_KT_ZKT_OpenFile.Visible = false;
                if(index == 0)
                    btn_JH_XM_KT_ZKT_AddFile.Visible = btn_JH_XM_KT_ZKT_OpenFile.Visible = true;
                else if(index == 1)//文件核查
                {
                    if(objid != null)
                    {
            ...
            {
                object objid = dgv_JH_KT_ZKT_FileList.Tag;
                btn_JH_KT_ZKT_AddFile.Visible = btn_JH_KT_ZKT_OpenFile.Visible = false;
                if(index == 0)
                    btn_JH_KT_ZKT_AddFile.Visible = btn_JH_KT_ZKT_OpenFile.Visible = true;
                else if(index == 1)//文件核查
                {
                    if(objid != null)
                    {
            ...
            {
                object objid = dgv_Imp_FileList.Tag;
                btn_Imp_AddFile.Visible = btn_Imp_OpenFile.Visible = false;
                if(index == 0)
                    btn_Imp_AddFile.Visible = btn_Imp_OpenFile.Visible = true;
                else if(index == 1)//文件核查
                {
                    if(objid != null)
                    {
            ...
            {
                object objid = dgv_Imp_Dev_FileList.Tag;
                btn_Imp_Dev_AddFile.Visible = btn_Imp_Dev_OpenFile.Visible = false;
                if(index == 0)
                    btn_Imp_Dev_AddFile.Visible = btn_Imp_Dev_OpenFile.Visible = true;
                else if(index == 1)//文件核查
                {
                    if(objid != null)
                    {
        ...
        private void Btn_AddFile_Click(object sender, EventArgs e)
        {
            ...
            if("btn_JH_AddFile".Equals(name))
                new Frm_AddFile(dgv_JH_FileList, string.Empty).ShowDialog();
            else if("btn_JH_XM_AddFile".Equals(name))
                new Frm_AddFile(dgv_JH_XM_FileList, "jh_xm_").ShowDialog();
            else if("btn_JH_XM_KT_AddFile".Equals(name))
                new Frm_AddFile(dgv_JH_XM_KT_FileList, "jh_xm_kt_").ShowDialog();
            else if("btn_JH_XM_KT_ZKT_AddFile".Equals(name))
                new Frm_AddFile(dgv_JH_XM_KT_ZKT_FileList, "jh_xm_kt_zkt_").ShowDialog();
            else if("btn_JH_KT_AddFile".Equals(name))
                new Frm_AddFile(dgv_JH_KT_FileList, "jh_kt_").ShowDialog();
            else if("btn_JH_KT_ZKT_AddFile".Equals(name))
                new Frm_AddFile(dgv_JH_KT_ZKT_FileList, "jh_kt_zkt_").ShowDialog();
            else if("btn_Imp_AddFile".Equals(name))
                new Frm_AddFile(dgv_Imp_FileList, "imp_").ShowDialog();
            else if("btn_Imp_Dev_AddFile".Equals(name))
                new Frm_AddFile(dgv_Imp_Dev_FileList, "imp_dev_").ShowDialog();
        }
        /// <summary>
        /// 上下移动
        /// </summary>
